...
```
הוסף פריטים לרשימת קניות קיימת או צור חדשה.

**אפשרויות:**
- `רשימת קניות: חלב, לחם, ביצים` - מוסיף לרשימה "רשימת קניות"
- `רשימת קניות [שבועי]: חלב, לחם, ביצים` - מוסיף לרשימה עם שם ספציפי

**ניהול רשימות:**
- `מחק רשימת קניות` - מוחק את רשימת הקניות הראשית
- `מחק רשימת קניות [שם]` - מוחק רשימה ספציפית
- `מחק את כל רשימות הקניות` - מוחק את כל רשימות הקניות
- `מחק מרשימת קניות: חלב` - מוחק פריט ספציפי מרשימת הקניות הראשית
- `מחק מרשימת קניות [שם]: חלב` - מוחק פריט ספציפי מרשימה ספציפית
